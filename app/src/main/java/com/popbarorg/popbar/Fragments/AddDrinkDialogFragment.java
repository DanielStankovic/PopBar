...
public class AddDrinkDialogFragment extends AppCompatDialogFragment implements View.OnClickListener {


    private EditText drinkName, barcode, drinkvolume, drinkFullWeight, drinkEmptyWeight;
    ...
    private String barCodeOfDrink;
    private String volumeOfDrink;
    private String emptyWeightOfDrink;
    private String fullWeightOfDrink;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.add_drink_fragment, null);


        drinkName = view.findViewById(R.id.drinkNameEditText);
        barcode = view.findViewById(R.id.drinkBarcodeEt);
        drinkvolume = view.findViewById(R.id.volumeEt);
        drinkFullWeight = view.findViewById(R.id.weightFullEt);
        drinkEmptyWeight = view.findViewById(R.id.weightEmptyEt);
    ...
    private void submitNewDrinkToDatabase() {
        ...
        volumeOfDrink = drinkvolume.getText().toString().trim();
        emptyWeightOfDrink = drinkEmptyWeight.getText().toString().trim();
        fullWeightOfDrink = drinkFullWeight.getText().toString().trim();
        if(!TextUtils.isEmpty(nameOfDrink)&& !TextUtils.isEmpty(barCodeOfDrink)&& !TextUtils.isEmpty(volumeOfDrink)
                && !TextUtils.isEmpty(emptyWeightOfDrink)&& !TextUtils.isEmpty(fullWeightOfDrink)){
    ...
    private void createAlertDialog() {
        ...
        takePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               AddDrinkDialogFragment.this.startActivityForResult(intent, Constants.CAMERA_CODE );
            }
        });
        ...
        importPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AddDrinkDialogFragment.this.startActivityForResult(galleryIntent, Constants.GALLERY_CODE);
            }
        });
    ...
    private class BackgroundImageResize extends AsyncTask<Uri, Integer, byte[]> {
        ...
        protected void onPostExecute(byte[] bytes) {
            ...
            DrinkModel drinkModel = new DrinkModel(barCodeOfDrink, nameOfDrink, volumeOfDrink, fullWeightOfDrink, emptyWeightOfDrink
            ,formattedDate, bytes, false);

            drinkModel.save();

            Toast.makeText(getActivity(), "Pice sacuvano", Toast.LENGTH_SHORT).show();

            AllDrinksFragment allDrinksFragment = (AllDrinksFragment) AddDrinkDialogFragment.this.getParentFragment();
            if(allDrinksFragment != null) {
                allDrinksFragment.refreshList();
            }

            AddDrinkDialogFragment.this.dismiss();
